...
MIN_AREA = 2500 #before 2000 or 1750
KP = 0.002
KD = 0.001

PIXEL_DEADBAND = 30 # 25 IS OK BUT STILL A LOT OF CORRECTIONS
MAX_OUTPUT = 0.35
REQUIRED_CENTERED_FRAMES = 3

OFFSET_RATIO_YELLOW_RIGHT = 0.20
OFFSET_RATIO_YELLOW_LEFT = -0.3 # NEED TO CALIBRATE THIS PART
